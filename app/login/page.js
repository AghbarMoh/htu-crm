...
export default function LoginPage() {
  ...
  const fullSubtitle = 'Sign in to your account'
  ...
  const lightUp = () => {
    ...
    setFlickering(true)
    setBulbOn(true)
    setTimeout(() => setBulbOn(false), 80)
    setTimeout(() => setBulbOn(true), 160)
    setTimeout(() => setBulbOn(false), 210)
    setTimeout(() => setBulbOn(true), 320)
    setTimeout(() => setBulbOn(false), 360)
    setTimeout(() => {
      setBulbOn(true)
      setFlickering(false)
    }, 500)
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          {/* Bulb SVG — all colors now key off bulbOn, transition disabled during flicker */}
          <svg
            width="44" height="56"
            viewBox="0 0 44 56"
            fill="none"
            ...
            style={{
              filter: bulbOn
                ...
                : 'none',
              transition: flickering ? 'none' : 'filter 0.6s ease',
            }}
          >
            <path
              d="M14 36C10 31 8 26 8 21C8 13.3 14.3 7 22 7C29.7 7 36 13.3 36 21C36 26 34 31 30 36L28 42H16L14 36Z"
              fill={bulbOn ? '#FFE040' : '#333'}
            />
            <rect x="16" y="42" width="12" height="4" rx="2" fill={bulbOn ? '#CCA020' : '#444'} />
            <rect x="17" y="46" width="10" height="4" rx="2" fill={bulbOn ? '#CCA020' : '#444'} />
            <line x1="22" y1="0" x2="22" y2="7" stroke="#555" strokeWidth="2" />
            <line x1="18" y1="30" x2="18" y2="38" stroke={bulbOn ? '#FFF8DC' : '#555'} strokeWidth="1.5" />
            <line x1="22" y1="28" x2="22" y2="38" stroke={bulbOn ? '#FFF8DC' : '#555'} strokeWidth="1.5" />
            <line x1="26" y1="30" x2="26" y2="38" stroke={bulbOn ? '#FFF8DC' : '#555'} strokeWidth="1.5" />
          </svg>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '32px' }}>
              ...
              <p style={{
                ...
                {subtitle}
                {subtitle.length < fullSubtitle.length && lit && (
                  <span style={{
